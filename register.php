 ...
 <form method="POST" action="handlers/registerHandler.php" class="py-4 px-4" ng-submit="submitForm(regForm.$valid)" name="regForm" novalidate>
   ...
   <div class="form-row justify-content-center">
     ...
     <div class="col-md-5 mb-3" ng-class="{ 'help-block' : regForm.username_reg.$invalid && !regForm.username_reg.$pristine }">
       ...
       <div ng-show="regForm.username_reg.$invalid && !regForm.username_reg.$pristine" class="help-block">
     ...
     <div class="col-md-5 mb-3" ng-class="{ 'help-block' : regForm.password_reg.$invalid && !regForm.password_reg.$pristine }">
       ...
       <input type="password" class="form-control" name="password_reg" id="validationCustom02" placeholder="Password" ng-model="password_reg" pw-check="password2_reg" ng-pattern="pattern" ng-minlength="9" required>
       <div ng-show="regForm.password_reg.$invalid && !regForm.password_reg.$pristine" class="help-block">
         <p ng-show="regForm.password_reg.$error.minlength" class="help-block">
           Please enter at least 9 characters.
         </p>
         <p ng-show="regForm.password_reg.$error.pattern" class="help-block">
   ...
   <div class="form-row justify-content-center">
     ...
     <div class="form-group col-md-5 mb-3" ng-class="{ 'help-block' : regForm.email_reg.$invalid && !regForm.email_reg.$pristine }">
       ...
       <input type="email" class="form-control" name="email_reg" id="validationCustom03" placeholder="Email" ng-model="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,}$" required>
       <div>
     ...
     <div class="col-md-5 mb-3" ng-class="{ 'help-block' : regForm.password2_reg.$invalid && !regForm.password2_reg.$pristine }">
       ...
       <input type="password" class="form-control" ng-model="password2_reg" name="password2_reg" id="validationCustom04" placeholder="Confirm Password" required>
       <div>
         <p ng-show="regForm.password_reg.$error.pwmatch" class="help-block">
   ...
   <div class="form-row justify-content-center">
     ...
     <div class="col-md-5 mb-3" ng-class="{ 'help-block' : regForm.first_name_reg.$invalid && !regForm.first_name_reg.$pristine }">
       ...
       <input type="text" class="form-control" name="first_name_reg" id="validationCustom05" placeholder="First name" ng-model="first_name_reg" pattern="[a-zA-Z]{2,25}" required>
       <div>
     ...
     <div class="col-md-5 mb-3" ng-class="{ 'help-block' : regForm.last_name_reg.$invalid && !regForm.last_name_reg.$pristine }">
       ...
       <input type="text" class="form-control" name="last_name_reg" id="validationCustom06" placeholder="Last name" ng-model="last_name_reg" pattern="[a-zA-Z]{2,40}" required>
       <div>
   ...
   <div class="form-row justify-content-center">
     ...
     <div class="col-md-6 mb-3" ng-class="{ 'help-block' : regForm.address_reg.$invalid && !regForm.address_reg.$pristine }">
       <label>Address</label>
       <input type="text" class="form-control" name="address_reg" id="validationCustom07" placeholder="Address" ng-model="address_reg" pattern="[a-zA-Z0-9 ]{2,50}" required>
       <div>
     ...
     <div class="col-md-4 mb-3">
       ...
       <input type="text" class="form-control" name="address2_reg" id="validationCustom08" placeholder="Address2" pattern="[a-zA-Z0-9 ]{2,50}">
     </div>
   </div>
   ...
   <div class="form-row justify-content-center">
     <div class="col-md-6 mb-3" ng-class="{ 'help-block' : regForm.city_reg.$invalid && !regForm.city_reg.$pristine }">
       ...
       <!-- City Input Field -->
       <label>City</label>
       <input type="text" class="form-control" name="city_reg" id="validationCustom09" placeholder="City" ng-model="city_reg" pattern="[a-zA-Z ]{2,100}" required>
       <div>
     ...
     <div class="col-md-4 mb-3" ng-class="{ 'help-block' : regForm.state_reg.$invalid && !regForm.state_reg.$pristine }">
       <label>State</label>
       <input type="state" class="form-control" name="state_reg" id="validationCustom10" placeholder="State" ng-model="state_reg" pattern="[A-Z]{2}" ng-minlength="2" ng-maxlength="2" required>
       <div>
